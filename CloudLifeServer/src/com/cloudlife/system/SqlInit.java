...
public class SqlInit {
	...
	final String m_strCreateUser = "create table if not exists user_info (uid int auto_increment primary key,"
				+ "name nvarchar(20),sex char, phone varchar(11), password varchar(13) not null"
				+",birthday datetime  null, weight float null, height int null,city nvarchar(10), bodyType nvarchar(8) null, sign nvarchar(51) null)ENGINE=InnoDB DEFAULT CHARSET=utf8;";
	...
	/*	Properties props = new Properties();
		...
		m_url="jdbc:mysql://localhost:3306/cloud_life?useUnicode=true&characterEncoding=utf8";
		m_user="root";
